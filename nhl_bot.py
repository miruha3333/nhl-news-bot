...
ПЕРЕД ТЕМ КАК ВЫДАТЬ ОТВЕТ, ВЫПОЛНИ АНАЛИЗ И САМОПРОВЕРКУ ШАГ ЗА ШАГОМ:

СТРУКТУРА ТВОЕГО ОТВЕТА ДОЛЖНА БЫТЬ СЛЕДУЮЩЕЙ:

[АНАЛИЗ ОРИГИНАЛА]
1. Выпиши строго все имена игроков, тренеров, менеджеров и названия клубов, которые ЕСТЬ В ОРИГИНАЛЕ.
2. Напиши, каких игроков и клубов в тексте НЕТ.

[ЧЕРНОВИК И ПРОВЕРКА НА ГАЛЛЮЦИНАЦИИ]
1. Напиши предварительный вариант перевода.
2. Проверь черновик: Не добавил ли ты туда фамилии игроков или названия клубов из своей памяти (например, если в тексте Adin Hill и Hart, не приплёл ли ты туда Броссуа? Если в тексте Devils и Hayton, не приплёл ли ты туда Аризону?). 
3. Если обнаружил скрытую отсебятину или лишние имена, которых не было в оригинале — жестко сотри их и перепиши текст.

[FINAL_POST]
Внутри этого блока должен быть ТОЛЬКО готовый и проверенный новостной пост, оформленный по правилам ниже, и в самом конце строка SEARCH_QUERY. Никаких других слов внутри этого блока быть не должно!
[/FINAL_POST]

СТРОГИЕ ПРАВИЛА ДЛЯ БЛОКА [FINAL_POST]:
1. ЖЕСТКАЯ ФАКТОЛОГИЯ: Передавай ТОЛЬКО ту информацию, которая напрямую написана в предоставленном тексте. КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО использовать свои внутренние фоновые знания, чтобы самостоятельно "дописывать" контекст. Если написаны фамилии Hill и Hart — в посте должны быть ТОЛЬКО Хилл и Харт. Никаких Броссуа!
2. НАЗВАНИЯ КЛУБОВ В ИМЕНИТЕЛЬНОМ ПАДЕЖЕ: Всегда используй официальные названия команд или городов (Чикаго, Эдмонтон, Вегас и т.д.) только в ИМЕНИТЕЛЬНОМ ПАДЕЖЕ. КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО склонять названия клубов (никаких "у Вегаса", "в Нью-Джерси"). Полностью перестраивай предложение, чтобы оно звучало грамотно.
   - Пример: "Kelly McCrimmon indicated he'll keep him as a duo with Hart." -> ✅ Правильно: "Келли МакКриммон дал понять, что Адин Хилл останется, и Вегас [им. падеж] сохранит его в качестве дуэта с Картером Хартом."
3. ПРОЗВИЩА: КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО использовать прозвища команд (никаких "рыцарей", "дьяволов", "ястребов").
4. АББРЕВИАТУРЫ: GM -> генеральный менеджер.
5. АВТОРСТВО: Формат первой строки строго такой: [Имя Автора по-английски]: [Текст поста].
6. ГЛОССАРИЙ ИМЕН ИГРОКОВ:
{names_glossary}

7. ФИНАЛ: В самой последней строке внутри тегов [FINAL_POST] напиши строго: SEARCH_QUERY: [Имя главного игрока на английском] NHL match
