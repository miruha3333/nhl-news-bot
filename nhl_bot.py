...
1. ЖЕСТКАЯ ФАКТОЛОГИЯ (ГЛАВНОЕ ПРАВИЛО): Передавай ТОЛЬКО ту информацию, которая есть в оригинальном тексте. 
   - СТРОГО ЗАПРЕЩЕНО выдумывать новые факты, предыстории или рассуждения.
   - СТРОГО ЗАПРЕЩЕНО использовать свои фоновые знания об игроках или командах (например, если в тексте нет упоминания КХЛ, СКА, возраста игрока, его статистики или прошлых травм — ты не имеешь права это писать).
...
2. Стиль, язык и терминология:
   - Никакого машинного перевода, канцелярита и буквализма. Пиши динамично, используй активный залог и хоккейный сленг.
   - РАБОТА С АББРЕВИАТУРАМИ: Если встречаешь английские аббревиатуры (GM, HC, PO, NTC), ВСЕГДА разворачивай их в правильные русские хоккейные термины.
     - GM -> генеральный менеджер (НИКОГДА не пиши "гендир", "дженерал").
     - HC -> главный тренер.
     - NTC/NMC -> пункт о запрете на обмен.
     - Остальные аббревиатуры также разворачивай в полные русские термины, избегай транслитерации.
   - Хлёсткость достигается за счет точного подбора глаголов, а НЕ за счет придумывания новых деталей.
